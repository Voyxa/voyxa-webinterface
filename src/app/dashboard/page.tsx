        ...
        <div className="max-h-screen pt-[50px] ">
            <div className="bg-white rounded-lg shadow p-6 mb-6">
                <div className="flex justify-between items-start space-x-4">
                    ...
                    <div className="bg-blue-100 p-6 rounded-lg flex-1 flex flex-col">
                        <h2 className="text-2xl font-bold mb-2">voyxa</h2>
                        <p className="text-4xl font-bold mb-4">3</p>
                    ...
                    <div className="bg-gray-100 p-6 rounded-lg flex-1 flex flex-col">
                    ...
                    <div className="bg-blue-100 p-6 rounded-lg flex-1 flex flex-col">
                        ...
                        <p className="mb-4">Just want to test voyxa's agent?</p>
                        <div className="mt-auto">
                            <button className="bg-blue-500 text-white px-4 py-2 rounded-lg">Call Now</button>
                        </div>
                    </div>
                </div>
            </div>
